...
class MongoDBHelper {
  ...
  /**
     ...
     * @returns {Promise}
     */
  getOneOptimized(params) {
    return new Promise((resolve, reject) => {
      let projection = params.projection || null
      const query = this.mongoDBModel.find(params.conditions, projection).limit(1);
  ...
  getBulk(parameters) {
    ...
    return new Promise((resolve, reject) => {
      ...
      let projection = params.projection || null
      const query = this.mongoDBModel.find(params.conditions, projection);
  ...
  hardDelete(params){
    return new Promise((resolve, reject) => this.mongoDBModel.findOneAndDelete(params.conditions,
        (error, response) => {
          if (error) {
            return reject(error);
          }
